...
cssclasses: `table-fc`, `table-lc`, `table-alt`, `table-lr`
...
cssclasses `tabelle-es`, `tabelle-ls`, `tabelle-alt`, `tabelle-lr`
...
>`m` = monochrome
>`xy` = cartesian x and y axes


![table-m–1](https://github.com/Jopp-gh/Obsidian-Dune84/assets/48620536/d5dce96f-4437-461e-bdea-2f21532001cb) ![table-m–2](https://github.com/Jopp-gh/Obsidian-Dune84/assets/48620536/15ea1b39-9fb9-4c26-8366-17dbb89b2e6d)

LEFT: use `cssclasses: table-m`, RIGHT: use `cssclasses: table-xym`
...
cssclasses `tabelle-m`, `tabelle-xym`
...
**Options** cssclasses : `table-r`,`table-g`,`table-b`
...
#### Deutsch 
cssclasses: `tabelle-r`,`tabelle-g`,`tabelle-b`

<br>

### DOUBLE HEADED TABLE
2 axes in red, green, blue, monochrome (xyr, xyg, xyb, xym)

**Options** cssclasses: `table-xyr`,`table-xyg`,`table-xyb`, `table-xym`
...
#### Deutsch 
cssclasses: `tabelle-xyr`,`tabelle-xyg`,`tabelle-xyb`, `tabelle-xym`
